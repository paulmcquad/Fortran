program roots
    ...
    ! How to find the roots of an quadratic equation - Free Math Help  https://www.youtube.com/watch?v=ROTzYjLcvE0
    !
    IMPLICIT NONE
    ...
    READ (*,*) a, b, c ! Echo back coefficients
    WRITE (*,*) 'The coefficients A, B, and C are: ', a, b, c  ! Calculate discriminant
    discriminant = b**2 - 4. * a * c    ! Solve for the roots, depending upon the value of the discriminant
